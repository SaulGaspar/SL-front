  ...
  return (
    <div>
      ...
      >
        ...
        <a href="/catalogo" className="btn btn-primary btn-lg mt-3">Ver catálogo</a>
      </div>
      ...
      <div className="container my-5">
        <div className="row g-4">
          ...
          {[{
            ...
            title:"Compromiso",
            text:"Nos comprometemos a mejorar continuamente nuestra plataforma, garantizando una experiencia de compra intuitiva, accesible y con los mejores estándares del mercado."
          }].map((card,i)=>(
