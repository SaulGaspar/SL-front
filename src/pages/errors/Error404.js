...
export default function Error404() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-slate-200 px-4 py-12">
      {/* Card principal */}
      <div className="relative bg-white rounded-3xl shadow-[0_30px_80px_rgba(0,0,0,0.15)] p-8 md:p-14 max-w-2xl w-full text-center">
        {/* Glow decorativo */}
        ...
        {/* Código */}
        <h1 className="text-7xl md:text-[140px] font-black text-yellow-500 leading-none">
          404
        </h1>
